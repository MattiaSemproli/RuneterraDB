<?php
    ...
    // $champions = json_decode(file_get_contents("..\json\champions.json"));
    // var_dump($champions);
    // sort($champions);
    // echo "<br>";
    // var_dump($champions);
    ...
    // $lore = json_decode(file_get_contents("..\json\cs.json"));
    // $lore = $lore->data;
    // foreach($lore as $l) {
    //     print($l->name);
    //     echo "<br>";
    ...
    //AGGIUNGERE FILE PHP PER CARICARE I DATI DI UNA PARTITA

    //AGGIUNGERE FILE PHP PER CONTROLLARE CHE IL GIOCATORE NON ABBIA GIOCATO GIA PIU DI 5 PARTITE
?>